      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            ...
            <p><span class="d-block">Email:</span> <span> info@AutoFix.com</span></p>
          </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | AutoFix <i class="fa fa-heart-o" aria-hidden="true"></i>
