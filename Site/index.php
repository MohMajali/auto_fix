    ...
    ?>
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            <div class="media media-custom d-block mb-4">
              <a href="./Mechanices.php?specialization_id=<?php echo $specialization_id ?>" class="mb-4 d-block"><img src="./img/specialization.png" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <!-- <span class="meta-post">February 26, 2018</span> -->
                <h2 class="mt-0 mb-3"><a href="#"><?php echo $specialization ?></a></h2>
              </div>
            </div>
          </div>
          <?php
